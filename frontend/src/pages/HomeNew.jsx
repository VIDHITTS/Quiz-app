...
import { Zap, TrendingUp, Users, Award, ArrowRight, Play, Sparkles, BookOpen, Target } from "lucide-react";
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
          <div className="text-center">
            ...
            >
              Create, share, and take interactive quizzes. Track your progress and compete with friends.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Everything you need to create engaging quizzes and track your learning progress
            </p>
          </motion.div>
